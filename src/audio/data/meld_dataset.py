...
class MELDDataset(Dataset):
    ...
    def prepare_data(self) -> None:
        ...
        for sample in tqdm(self.metadata.values):
            ...
            sample_emo = sample[5:12].astype(int)
            sample_sen = sample[4]
...
if __name__ == "__main__":
    ...
    for ds in ['train', 'dev', 'test']:
        ...
        dump_filepath = os.path.join(data_config['DATA_ROOT'], 'MELD_{}_{}'.format(ds.upper(), data_config['FEATURES_DUMP_FILE']))
